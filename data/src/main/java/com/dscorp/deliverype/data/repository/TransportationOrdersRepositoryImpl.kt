...
class TransportationOrdersRepositoryImpl(
    ...
    override suspend fun getNewTransportationOrders(): Either<Exception, List<TransportationOrder>> {
    ...
    override suspend fun getTakenTransportationOrders(driverId: String): Either<Exception, List<TransportationOrder>> {
    ...
    override suspend fun getHistoryOfTransportationOrders(driverId: String): Either<Exception, List<TransportationOrder>> {
